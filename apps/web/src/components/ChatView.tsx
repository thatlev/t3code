...
function ChatViewContent(props: ChatViewProps) {
  ...
  const onSend = async (
    ...
    // expandBuiltinSkills is ours: upstream hoisted this block above the
    // provider-input validation, so the wrapper has to move with it or the
    // skill placeholders ship to the model unexpanded.
      ...
      switch (command.kind) {
        ...
        case "fork":
          toastManager.add({
            ...
            description: "T3 Code does not expose a provider-safe conversation fork yet.",
            type: "info",
          });
          break;
        case "clear":
